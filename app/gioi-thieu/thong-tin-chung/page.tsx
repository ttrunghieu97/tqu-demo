...
export const metadata: Metadata = {
  title: 'Thông tin chung - Trường Đại Học Tân Trào',
...
export default function ThongTinChung() {
  return (
    <>
      <h1 className="text-3xl md:text-4xl font-bold text-center my-5 uppercase dark:text-white">
        Thông tin chung
      </h1>
      1. Vị trí địa lý
      ...
      Tuyên Quang chưa có đường sắt và đường không vì vậy việc thông thương sang các tỉnh khác và ra nước ngoài nhờ vào hệ thống đường bộ quốc lộ 2 và quốc lộ 37; tỉnh có sông Lô chảy qua nên rất thuận lợi cho việc phát triển giao thông đường thuỷ.
      2. Đặc điểm địa hình
      ...
      Tuyên Quang gồm có 1 thành phố và 6 huyện: Chiêm Hoá, Hàm Yên, Lâm Bình, Na Hang, Sơn Dương, Yên Sơn, với 141 đơn vị cấp xã gồm 7 phường, 5 thị trấn và 129 xã.

      5. Kinh tế

      Tuyên Quang là tỉnh miền núi, nền kinh tế nông-lâm nghiệp chiếm ưu thế, mô hình kinh tế trang trại kết hopwj nông lâm. Trong bảng xếp hạng về Chỉ số năng lực cạnh tranh cấp tỉnh của Việt Nam năm 2011 tỉnh Tuyên Quang xếp ở vị trí thứ 56/63 tỉnh thành.
      ...
      Công nghiệp: có quặng kẽm, quặng mangan, quặng thiếc, bột kẽm, khai thác awntimoan... Sản xuất giấy, bột giấy, xi măng, vôi.
