...
import { getPostsForCategory, getCategoryTitle } from "@/app/api/directus/utils"; // Import các hàm đã viết
...
export default function CategoryPage({ params, searchParams }: PageProps) {
  ...
  const category = params.category; // Lấy category từ params
  const page = Number(searchParams.page) || 1; // Lấy trang hiện tại từ searchParams
