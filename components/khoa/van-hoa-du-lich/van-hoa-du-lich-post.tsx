...
export default function VanhoadulichPost() {
        ...
        {posts.map((post) => {
          ...
          return (
            <Card key={post.id} className="group hover:shadow-lg transition-shadow duration-300">
              <Link href={`/khoa/su-pham/${post.slug}`}>
              ...
              <CardContent className="p-6">
                ...
                <Link href={`/khoa/su-pham/${post.slug}`} className="block group-hover:text-primary transition-colors">
