  ...
  return (
    <div className="container mx-auto px-4">
          ...
          return (
            <>
              <Link href={`${pathname}/${post.slug}`}>
                <Card key={post.id} className="group hover:shadow-lg transition-shadow duration-300 overflow-hidden mt-5">
      ...
      <div className="flex justify-center items-center mt-5">
        <Link href="href">
          <Button className="bg-gradient-to-r from-red-500 to-yellow-500 text-white px-6 rounded-lg hover:from-yellow-500 hover:to-red-500 transition-all duration-300">
            Xem thêm
          </Button>
        </Link>
      </div>
